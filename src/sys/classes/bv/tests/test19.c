...
static char help[] = "Test BV block orthogonalization with constraints.\n\n";
...
int main(int argc,char **argv)
{
  ...
  ierr = PetscPrintf(PETSC_COMM_WORLD,"Test BV block orthogonalization with %D columns + %D constraints, of length %D.\n",k,nc,n);CHKERRQ(ierr);
